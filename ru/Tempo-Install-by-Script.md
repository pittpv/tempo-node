...
5. После загрузки образа скрипт спросит, нужно ли **скачивать снепшот цепи** для выбранной версии. Если ответить **да**, будет показан список доступных снепшотов для этой сети, и можно выбрать один из них (или взять последний). Если ответить **нет**, нода будет перезапущена только с новым образом, с использованием уже существующих данных цепи.
